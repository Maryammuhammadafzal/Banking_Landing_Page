...
const FeaturesPage = () => {
  ...
  return (
    <div className="w-full h-auto flex justify-center items-center">
      <div className="lg:w-[90%] w-full px-3 h-auto py-20 gap-10 md:flex-row flex-col flex">
        ...
        <div className="cards w-full flex flex-wrap gap-10 justify-center items-center">
          <div className="w-[440px] h-[440px] relative sm:gap-10 gap-5 flex flex-wrap">
            ...
            <Card className="sm:w-[200px] w-[150px] bg-[#E6E6E6] sm:h-[200px] h-[150px] flex justify-center items-center">
              <CardContent className="flex flex-col gap-3 justify-center items-center text-center">
                ...
                className=""
                />
                <p className="font-bold">24/7 Account Access</p>
              </CardContent>
            </Card>
            <Card className="sm:w-[200px] w-[150px] bg-[#E6E6E6] sm:h-[200px] h-[150px] flex justify-center items-center">
              <CardContent className="flex flex-col gap-3 justify-center items-center text-center">

      ...
      <div className=" w-full h-full flex justify-center items-center">
        <div className="lg:w-[90%] w-full px-3 h-full items-center justify-start flex flex-col gap-4">
            <div className="flex md:flex-row flex-col w-full h-full items-center ">
              ...
              <div className="md:w-[45%] w-full h-auto relative justify-end flex">
                <Image
                  src={ContactImage}
                  alt="hero-image"
                  width={690}
                  height={529}
                  className="z-20 scale-x-[-1] w-[1000px]"
                />
                <div className="xl:min-w-[370px] md:w-[320px] md:h-[320px] xl:h-[370px] rounded-full bg-[#C7D216] -right-30  absolute -bottom-20"></div>
              </div>
            </div>
        </div>
      </div>
